...
public class BrickBreaker extends GraphicsProgram {
    ...
    public SoundClip win = new SoundClip("Sounds/win.wav");
    public SoundClip lose = new SoundClip("Sounds/fail.wav");
    public SoundClip losePoint = new SoundClip("Sounds/losePoint.wav");
    public SoundClip soundtrack = new SoundClip("Sounds/soundtrack.wav");
    public SoundClip hit = new SoundClip("Sounds/hit.wav");
    public SoundClip bounce = new SoundClip("Sounds/bounce.wav");
